...
class ServiceDetector:
    ...
    def scan_services_directory(self) -> List[Dict[str, Any]]:
        ...
        notion_service_included = any(
            s["name"] == "Notion Service" for s in self.services
        )
        ...
        integration_manager_included = any(
            s["name"] == "Integration Manager" for s in self.services
        )
            ...
            self.services.append(
                {
                    ...
                    "functions": SERVICE_FUNCTIONS_TEMPLATE.get(
                        "IntegrationManager", []
                    ),
                }
            )
...
class ArchitectureUpdater:
    ...
    def update_html(self) -> bool:
        ...
        try:
            ...
            print(
                f"Updated architecture visualization with {len(self.services)} services"
            )
            return True
