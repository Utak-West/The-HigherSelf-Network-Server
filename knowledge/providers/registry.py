...
class EmbeddingProviderRegistry:
    ...
    def register_provider(self, provider: BaseEmbeddingProvider, priority: ProviderPriority):
        """
        ...
        logger.info(f"Registered embedding provider: {provider.provider_name} with priority {priority.name}")
