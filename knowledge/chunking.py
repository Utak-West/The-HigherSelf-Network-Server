...
class SentenceChunker(ChunkingStrategy):
    ...
    def chunk_text(self, text: str) -> List[str]:
        ...
        try:
            ...
            logger.warning(
                f"Error tokenizing text into sentences: {e}. Falling back to simple chunking."
            )
        ...
        for sentence in sentences:
            ...
            if current_size + sentence_size > self.chunk_size:
                ...
                overlap_start = max(
                    0, len(current_chunk) - self.chunk_overlap // 20
    ...
    def chunk_text(self, text: str) -> List[str]:
        ...
        for paragraph in paragraphs:
            ...
            if paragraph_size > self.chunk_size:
                ...
                paragraph_chunks = SentenceChunker(
                    self.chunk_size, self.chunk_overlap
...
def get_chunker(
    strategy: str = "semantic", chunk_size: int = 1000, chunk_overlap: int = 200
) -> ChunkingStrategy:
    """
