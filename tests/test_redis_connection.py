...
class TestRedisConfiguration:
    ...
    def test_redis_settings_validation(self):
        ...
        valid_settings = RedisSettings(
            host="localhost", port=6379, timeout=5, max_connections=10
        )
    ...
    def test_redis_connection_url_generation(self):
        ...
        settings = RedisSettings(
            host="redis.example.com", port=6380, database=1, password="secret123"
        )
        url = settings.get_connection_url()
    ...
    def test_redis_connection_kwargs(self):
        ...
        settings = RedisSettings(timeout=10, max_connections=20, ssl_enabled=True)
    ...
    async def test_redis_pubsub_integration(self):
        ...
        try:
            ...
            test_message = {
                ...
                "payload": {"task": "prepare_training_materials", "priority": "high"},
            }
