...
class NotionTasksManager:
    ...
    def __init__(self, database_id: Optional[str] = None):
        ...
        if not self.database_id:
            logger.warning("No Notion database ID provided. Will create a new database.")
    ...
    def setup_database(self, parent_page_id: str) -> str:
        ...
        response = notion.databases.create(
            ...
            properties={
                ...
                "Feedback Rating": {"type": "number", "number": {
                    "format": "number"
                }},
    ...
    def create_task(self, task: AgentTask) -> str:
        ...
        response = notion.pages.create(
            ...
            properties={
                ...
                "Task Type": {"select": {"name": self._format_task_type(task.task_type)}},
        ...
        if task.created_by:
            notion.pages.update(
                page_id=response["id"],
                properties={
                    "Created By": {"rich_text": [{"text": {"content": task.created_by}}]}
                }
            )
        ...
        blocks.extend([
            {
                ...
                "type": "heading_2",
                "heading_2": {
                    "rich_text": [{"type": "text", "text": {"content": "Parameters"}}]
                }
            },
            {
                "object": "block",
                "type": "code",
                "code": {
                    "rich_text": [{"type": "text", "text": {"content": parameters_text}}],
                    "language": "json"
                }
            },
            {
            ...
            },
            {
                ...
                "type": "paragraph",
                "paragraph": {
                    "rich_text": [{"type": "text", "text": {"content": "Results will appear here once the task is completed."}}]
                }
            }
        ])
    ...
    def update_task_result(self, task_id: str, result: str, status: str = "completed") -> None:
        """
        ...
        for block in blocks["results"]:
            if block["type"] == "heading_2" and block["heading_2"]["rich_text"][0]["text"]["content"] == "Results":
    ...
    def update_feedback(self, task_id: str, rating: int, comments: Optional[str] = None) -> None:
        """
    ...
    def get_recent_tasks(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        for page in query_result["results"]:
            ...
            task = {
                ...
                "feedback_rating": self._get_number_property(properties, "Feedback Rating"),
    ...
    def _get_date_property(self, properties: Dict[str, Any], name: str) -> Optional[str]:
    ...
    def _get_number_property(self, properties: Dict[str, Any], name: str) -> Optional[int]:
