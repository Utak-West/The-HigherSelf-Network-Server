...
class VideoContent(BaseModel):
    ...
    content_type: str = Field(ContentType.VIDEO.value, description="Content type (always VIDEO)")
    stage: str = Field(ContentStage.IDEA.value, description="Current stage in the content lifecycle")
    ...
    resolution: str = Field(VideoResolution.PORTRAIT.value, description="Video resolution")
    duration: Optional[float] = Field(None, description="Video duration in seconds")
    video_status: str = Field(VideoStatus.PENDING.value, description="Status of video generation")
    ...
    platforms: List[str] = Field(default_factory=list, description="Target platforms for distribution")
    voice_name: Optional[str] = Field(None, description="Voice used for narration")
    subtitle_settings: Optional[Dict[str, Any]] = Field(None, description="Subtitle configuration")
...
class VideoGenerationConfig(BaseModel):
    ...
    custom_script: Optional[str] = Field(None, description="Custom script for the video")
