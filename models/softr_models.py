...
class AgentRequest(BaseModel):
    ...
    request_type: str = Field(
        ..., description="Type of request (e.g., 'task', 'question', 'action')"
    )
    ...
    workflow_instance_id: Optional[str] = Field(
        None, description="ID of the workflow instance if applicable"
    )
...
class SoftrWebhookPayload(BaseModel):
    ...
    event_type: str = Field(
        ..., description="Type of event (e.g., 'new_staff_request')"
    )
