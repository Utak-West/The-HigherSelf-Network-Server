...
from models.huggingface_models import (
    HuggingFaceModelConfig, NotionHuggingFaceIntegration,
    HuggingFaceModelInfo, HuggingFaceTaskModels,
    HuggingFaceResponse, HuggingFaceProcessResponse
)
...
async def process_huggingface_integration(
    ...
    try:
        ...
        response = await huggingface_service.process_notion_integration(integration, page.properties)
