...
from services.crawl4ai_service import get_crawl4ai_service, CrawlConfig, Crawl4AIService
...
class CrawlRequest(BaseModel):
    ...
    content_filter_threshold: float = Field(0.48, description="Content filter threshold")
...
class CrawlResponse(BaseModel):
    ...
    content_length: Optional[int] = Field(None, description="Length of the extracted content")
...
class DeepCrawlResponse(BaseModel):
    ...
    embedding_ids: Optional[List[str]] = Field(None, description="IDs of the stored embeddings")
    error: Optional[str] = Field(None, description="Error message if crawl failed")
