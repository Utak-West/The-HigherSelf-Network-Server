...
from models.tesseract_models import (OCRBoundingBox, OCRImageSource,
                                     OCRLanguage, OCROutputFormat, OCRProvider,
                                     OCRRequest, OCRResponse, OCRTextElement)
...
class TesseractOCRService(BaseOCRService):
    ...
    def __init__(
        ...
        if not TESSERACT_AVAILABLE:
            logger.warning(
                "TesseractOCRService initialized but pytesseract is not installed."
            )
            return
