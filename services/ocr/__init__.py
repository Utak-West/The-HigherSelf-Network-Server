...
from services.ocr.google_vision_ocr_service import GoogleVisionOCRService, GOOGLE_VISION_AVAILABLE
from services.ocr.abbyy_ocr_service import ABBYYOCRService, ABBYY_AVAILABLE
...
if GOOGLE_VISION_AVAILABLE:
    OCRServiceFactory.register_service_class(OCRProvider.GOOGLE_VISION, GoogleVisionOCRService)
else:
    logger.warning("Google Cloud Vision OCR service not available. Install google-cloud-vision to enable it.")
