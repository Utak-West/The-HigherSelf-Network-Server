...
class OpenAIProvider(AIProvider):
    ...
    def __init__(self, api_key: str = None, organization_id: str = None, default_model: str = "gpt-4"):
        """
        ...
        try:
            ...
            if model.startswith(("gpt-4", "gpt-3.5")):
                response = await openai.ChatCompletion.acreate(
                    model=model,
                    messages=[
                        {"role": "system", "content": "You are a helpful assistant for The HigherSelf Network."},
