...
from .base_provider import AIProvider, AICompletionRequest, AICompletionResponse
...
class MockAIProvider(AIProvider):
    ...
    def _generate_mock_response(
        ...
        if "where" in prompt_lower:
            return f"This is a mock response about the location of {prompt.split()[-1]}."
        ...
        if "summarize" in prompt_lower or "summary" in prompt_lower:
            return f"This is a mock summary of {prompt.split()[-1]}. The key points are..."
