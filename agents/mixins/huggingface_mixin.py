...
class HuggingFaceMixin:
    ...
    async def get_huggingface_completion(
        self,
        task_type: str,
        content: str,
        language: str = "en",
        ...
        if not self.agent_model_service:
            if not self.ai_router:
                raise ValueError(
                    "AI Router not available. Call setup_huggingface first."
                )
    ...
    async def summarize_text(self, text: str, language: str = "en") -> str:
        ...
        return await self.get_huggingface_completion(
            task_type="summarize_content", content=text, language=language
        )
    ...
    async def generate_text(self, prompt: str, language: str = "en") -> str:
        ...
        """
        return await self.get_huggingface_completion(
            task_type="generate_text", content=prompt, language=language
        )
    ...
    async def translate_text(
        ...
        return await self.get_huggingface_completion(
            task_type=task_type, content=text, language=source_lang
        )
    ...
    async def analyze_sentiment(self, text: str, language: str = "en") -> str:
        ...
        """
        return await self.get_huggingface_completion(
            task_type="sentiment_analysis", content=text, language=language
        )

    async def answer_question(
        self, question: str, context: str, language: str = "en"
    ) -> str:
        """
        ...
        return await self.get_huggingface_completion(
            task_type="answer_question", content=content, language=language
        )
