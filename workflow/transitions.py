        ...
        if self.trigger_type == TransitionType.SCHEDULED:
            ...
            if self.schedule_frequency:
                ...
                if time_match:
                    ...
                    last_trigger = instance.context_data.get(
                        f"last_trigger_{self.name}"
                    )
                    if last_trigger:
...
class TransitionCondition(BaseModel):
    ...
    def is_satisfied(self, context_data: Dict[str, Any]) -> bool:
        ...
        if (
            ...
            and isinstance(self.expected_value, str)
...
class ConditionGroup(BaseModel):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ConditionGroup":
        ...
        return cls(conditions=conditions, operator=data.get("operator", "AND"))
