...
class WorkflowVisualizer:
    ...
    async def update_instance_visualization(
        ...
        if success:
            ...
            self.logger.error(f"Failed to update visualization for instance {instance_id}")
        
        return success
    
    async def generate_instance_history_timeline(
        self,
        instance_id: str
    ) -> str:
        """
        ...
        for entry in instance.history_log:
            ...
            state_transition_match = re.search(r"Transitioned from (\w+) to (\w+)", action)
        ...
        for i, transition in enumerate(transitions):
            end_time = transitions[i+1]["timestamp"] if i+1 < len(transitions) else datetime.now()
    ...
    async def generate_workflow_dashboard(
        ...
        filter_conditions = {
            ...
            "rich_text": {
                "equals": workflow.workflow_id
            }
        }
        
        all_instances = await notion_svc.query_database(WorkflowInstance, filter_conditions)
        ...
        completion_times = []
        for instance in all_instances:
            if instance.status == "Completed" and instance.created_at and instance.last_transition_date:
                completion_time = (instance.last_transition_date - instance.created_at).total_seconds() / 3600.0  # in hours
        ...
        try:
            ...
            blocks = [
                {
                    ...
                    "type": "heading_1",
                    "heading_1": {
                        "rich_text": [{"type": "text", "text": {"content": dashboard_content["title"]}}]
                    }
                },
                {
                    "object": "block",
                    "type": "paragraph",
                    "paragraph": {
                        "rich_text": [{"type": "text", "text": {"content": f"Generated at: {dashboard_content['generated_at']}"}}]
                    }
                },
                {
                    "object": "block",
                    "type": "heading_2",
                    "heading_2": {
                        "rich_text": [{"type": "text", "text": {"content": "Statistics"}}]
                    }
                }
            ]
            ...
            if dashboard_content.get("state_distribution_chart"):
                blocks.append({
                    ...
                    "type": "heading_2",
                    "heading_2": {
                        "rich_text": [{"type": "text", "text": {"content": "State Distribution"}}]
                    }
                })
                ...
                blocks.append({
                    ...
                    "code": {
                        "language": "mermaid",
                        "rich_text": [{"type": "text", "text": {"content": dashboard_content["state_distribution_chart"]}}]
                    }
                })
...
class NotionWorkflowDashboard:
    ...
    async def _update_dashboard(self):
        ...
        blocks = [
            {
                ...
                "type": "heading_1",
                "heading_1": {
                    "rich_text": [{"type": "text", "text": {"content": "Workflow Dashboard"}}]
                }
            },
            {
                "object": "block",
        ...
        comparison_chart = await self.visualizer.generate_workflow_comparison(self.workflows)
        blocks.append({
            "object": "block",
            "type": "heading_2",
            "heading_2": {
                "rich_text": [{"type": "text", "text": {"content": "Workflow Comparison"}}]
            }
        })
        blocks.append({
            "object": "block",
            ...
            "code": {
                "language": "mermaid",
                "rich_text": [{"type": "text", "text": {"content": comparison_chart}}]
            }
        })
        ...
        for workflow in self.workflows:
            ...
            blocks.append({
                ...
                "type": "heading_2",
                "heading_2": {
                    "rich_text": [{"type": "text", "text": {"content": workflow.name}}]
                }
            })
            ...
            blocks.append({
                ...
                "paragraph": {
                    "rich_text": [
                        {"type": "text", "text": {"content": f"Total Instances: {dashboard['total_instances']}\n"}},
                        {"type": "text", "text": {"content": f"Active Instances: {dashboard['active_instances']}\n"}},
                        {"type": "text", "text": {"content": f"Completed Instances: {dashboard['completed_instances']}\n"}},
                        {"type": "text", "text": {"content": f"Avg Completion Time: {dashboard['avg_completion_time_hours']:.2f} hours"}}
                    ]
                }
            })
            ...
            if dashboard.get("state_distribution_chart"):
                blocks.append({
                    ...
                    "code": {
                        "language": "mermaid",
                        "rich_text": [{"type": "text", "text": {"content": dashboard["state_distribution_chart"]}}]
                    }
                })
            ...
            blocks.append({
                ...
                "type": "heading_3",
                "heading_3": {
                    "rich_text": [{"type": "text", "text": {"content": "Workflow Diagram"}}]
                }
            })
            blocks.append({
                "object": "block",
