...
APP_NAME = "Code"
WEBSERVER_URL = "https://api.devin.ai/vscode-profile/484a441f-75ae-47c0-8b11-4be8b10db6c5"
CONFIRM_URL = "https://app.devin.ai/vscode-profile/484a441f-75ae-47c0-8b11-4be8b10db6c5/confirm"
DOT_DIR_NAME = ""
USER_DATA_PATH = ""
...
def get_extensions() -> List[Dict]:
    ...
    for extension in extensions:
        ...
        # TODO: disabled
        is_builtin = extension.get("isBuiltin", False) or metadata.get("isBuiltin", False)
        if is_builtin:
            continue
...
def main():
    ...
    try:
        ...
        system = platform.system()
        if system == "Darwin":
            USER_DATA_PATH = os.path.expanduser(f"~/Library/Application Support/{APP_NAME}/User")
        elif system == "Windows":
        ...
        RED = "\033[91m"
        RESET = "\033[0m"
        print(f"{RED}Failed to export profile. Follow the step-by-step instructions at https://docs.devin.ai/collaborate-with-devin/vscode-profiles as an alternative.{RESET}")
