...
# CapCut endpoints
@app.post("/capcut/export", response_model=CapCutExportResponse, dependencies=[Depends(verify_api_key)])
...
@app.get("/capcut/exports/{export_id}", response_model=CapCutExportStatusResponse, dependencies=[Depends(verify_api_key)])
...
# Pipit endpoints
@app.post("/pipit/payments", response_model=PipitPaymentResponse, dependencies=[Depends(verify_api_key)])
async def create_payment(
    ...
    """
    print(f"Received Pipit payment request for amount: {request.amount} {request.currency}")
...
@app.get("/pipit/payments/{payment_id}", response_model=PipitPaymentStatusResponse, dependencies=[Depends(verify_api_key)])
...
@app.post("/transactions", response_model=VideoTransactionResponse, dependencies=[Depends(verify_api_key)])
