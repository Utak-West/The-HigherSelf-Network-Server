...
class Context7RAG:
    ...
    async def query(self, query_text: str, collection_name: str = "default", 
                    filters: Dict[str, Any] = None, top_k: int = 5) -> Dict[str, Any]:
        """
    ...
    async def delete_document(self, doc_id: str, collection_name: str = "default") -> Dict[str, Any]:
        """
