...
class MemoryItem(BaseModel):
    ...
    importance: int = Field(
        default=1,
        description="Importance score (1-10, higher is more important)"
    )
...
class MemoryTool:
    ...
    def _register(self):
            ...
            parameters_schema={
                ...
                "properties": {
                    "operation": {
                        "type": "string",
                        "enum": [
                            "create", "get", "search", "update", "delete", "list"
                        ],
        ...
        memory_tool = MCPTool(
            metadata=metadata,
            handler=self.handle_memory_operation,
            is_async=True
        )
    ...
    async def _create_memory(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
        """Create a new memory."""
    ...
    async def _get_memory(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
        """Get a memory by ID."""
    ...
    async def _search_memories(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
    ...
    async def _update_memory(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
    ...
    async def _delete_memory(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
    ...
    async def _list_memories(self, params: Dict[str, Any], agent_id: str) -> Dict[str, Any]:
