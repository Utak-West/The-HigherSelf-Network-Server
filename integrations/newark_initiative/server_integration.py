...
class NewarkIntegration:
    ...
    async def initialize(self) -> bool:
        ...
        if not self._is_enabled():
            logger.warning(
                "Newark integration is disabled. Set NEWARK_API_ENABLED=True to enable."
            )
            return False
        ...
        if not NewarkConfig.is_configured():
            ...
            logger.error(
                "Please set all required environment variables as specified in the documentation."
            )
            return False
        ...
        try:
            ...
            terra = OutreachCoordinatorAgent(
                ...
                resource_availability_id=agent_configs["terra"][
            ...
            vesta = ProgramEvaluatorAgent(
                ...
                report_configurations_id=agent_configs["vesta"][
