...
try:
    ...
    LANGCHAIN_ACTIVE_AGENTS = Gauge(
        ...
        'Number of active LangChain agents'
    )
...
class PerformanceCallback(BaseCallbackHandler):
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        avg_duration = (
            self.performance_data["total_duration"] / self.performance_data["total_requests"]
            if self.performance_data["total_requests"] > 0 else 0
        )
