...
class HigherSelfRedisExamples:
    ...
    def cache_notion_response(self, database_id: str, response_data: Dict[str, Any], ttl: int = 300):
        """
    ...
    async def send_agent_message(self, from_agent: str, to_agent: str, message_type: str, payload: Dict[str, Any]):
        """
        ...
        logger.info(f"Sent {message_type} from {from_agent} to {to_agent} ({subscribers} subscribers)")
    ...
    async def listen_for_agent_messages(self, agent_id: str, callback):
        ...
        """
        channels = [
            f"higherself:agents:{agent_id}",
            "higherself:agents:broadcast"
        ]
    ...
    def get_agent_message_history(self, from_agent: str, to_agent: str, limit: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    def create_user_session(self, user_id: str, session_data: Dict[str, Any], ttl: int = 3600):
        """
    ...
    def check_rate_limit(self, identifier: str, limit: int, window: int = 3600) -> Dict[str, Any]:
        """
    ...
    def queue_background_task(self, task_type: str, parameters: Dict[str, Any], priority: str = "normal"):
        """
    ...
    def get_next_task(self, priority: str = "normal", timeout: int = 30) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_user_notifications(self, user_id: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        return [json.loads(notif) if isinstance(notif, str) else notif for notif in notifications]
