...
class WindsurfWorkflowConfig:
    ...
    def _load_config(self) -> None:
        ...
        try:
            ...
            self.loaded = True
            logger.info(f"Loaded {len(self.workflows)} workflows from Windsurf configuration")
    ...
    def is_valid_transition(self, workflow_id: str, from_state: str, to_state: str) -> bool:
