...
AGENT_DATABASE_MAPPING = {
    ...
    "TaskManagementAgent": ["Task", "WorkflowInstance", "NotificationTemplate"],
...
AUTOMATION_FLOW_MAPPING = {
    ...
    "Flow 2: Retreat Booking Management": ["BookingAgent", "TaskManagementAgent"],
    "Flow 3: Art Sale & Fulfillment": [
        "BookingAgent",  # Used for WooCommerce orders too
        "TaskManagementAgent",
    ],
    "Flow 4: Marketing Email Campaign": ["MarketingCampaignAgent", "LeadCaptureAgent"],
    "Flow 5: Automated Task Management": ["TaskManagementAgent"],
    "Flow 6: Community Engagement": ["CommunityEngagementAgent", "TaskManagementAgent"],
