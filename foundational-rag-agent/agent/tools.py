...
class KnowledgeBaseSearchTool:
    ...
    def __init__(self, supabase_client: SupabaseClient = None, embedding_generator: EmbeddingGenerator = None):
        """
    ...
    async def search(self, params: KnowledgeBaseSearchParams) -> List[KnowledgeBaseSearchResult]:
        ...
        query_embedding = await self.embedding_generator.generate_embedding(params.query)
    ...
    async def add_to_knowledge_base(self, content: str, source: str, source_type: str, metadata: Dict[str, Any] = None) -> str:
        """
